      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <a href="/" className="flex items-center gap-2 shrink-0">
          <img
            ...
            loading="eager"
          />
          <span className="sr-only">FlexiDesk</span>
        </a>
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm">
          ...
          <a
            href="/login"
            className="inline-flex items-center rounded-full bg-brand px-4 py-2 font-medium text-ink hover:opacity-90"
          >
            Get Started
          </a>
        </nav>
        ...
        <button
          className="md:hidden p-2 rounded hover:bg-charcoal/30"
      ...
      {open && (
        <div className="md:hidden border-t border-charcoal/40 bg-ink text-white">
          <div className="px-4 py-3 flex flex-col gap-3 text-sm">
            ...
            <a
              href="#get-started"
              className="rounded-md bg-brand px-3 py-2 text-ink text-center"
            >
              Get Started
            </a>
          </div>
